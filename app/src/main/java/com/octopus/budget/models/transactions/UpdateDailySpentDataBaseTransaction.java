...
/**
 * Created by octopus on 8/12/16.
 */
public class UpdateDailySpentDataBaseTransaction extends DataBaseTransaction {
    public UpdateDailySpentDataBaseTransaction(Context context, Context activityContext) {
        super(context, activityContext, 1000);
    }

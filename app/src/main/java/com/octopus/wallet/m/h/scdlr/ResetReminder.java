...
public class ResetReminder extends Scheduler {
    public ResetReminder(Context context) {
    ...
    public Params onGetParam() {
       Calendar calendar = Calendar.getInstance();
        ...
        Params params = new Params(
                ...
                INTENT_MESSAGE.RESET_MESSAGE,
                calendar);
        params.setInterval(INTERVAL_DAY);
        params.setRepeating(true);
        return params;
    }
}
